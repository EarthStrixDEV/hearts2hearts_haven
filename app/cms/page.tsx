...
export default function CMSDashboard() {
  ...
  const loadStats = useCallback(async () => {
    ...
    try {
      ...
      const newsResponse = await fetch('/api/news?pageSize=1000');
      if (newsResponse.ok) {
        ...
        setStats({
          ...
          scheduled,
          totalViews,
          totalMembers: 8, // Fixed number for members
          totalMusic: 12, // TODO: Load from music API when available
          totalEvents: 8, // TODO: Load from events API when available
          totalGalleryItems: 150, // TODO: Load from gallery API when available
        });
      }
    } catch (error) {
